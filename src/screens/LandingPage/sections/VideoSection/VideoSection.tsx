...
export const VideoSection = (): JSX.Element => {
  return (
    <section className="relative w-full flex items-end justify-center py-12 sm:py-16 lg:py-[70px] px-4 sm:px-8 lg:px-12 min-h-[400px] sm:min-h-[500px] lg:min-h-[659px] overflow-hidden">
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      {/* Content */}
      <div className="relative z-20 flex flex-col items-center gap-6 sm:gap-8 max-w-[602px] w-full">
